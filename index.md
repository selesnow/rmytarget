...
* shows - количество показов;<Br>
* clicks - количество кликов;<Br>
* goals - количество достижений целей (цели Top@Mail.ru для сайтов и установок для мобильных приложений);<Br>
* spent - списания;<Br>
* cpm - среднее списание за 1000 просмотров;<Br>
* cpc - среднее списание за 1 клик;<Br>
* cpa - среднее списание за достижение 1 цели;<Br>
* ctr - процентное отношение количества кликов к количеству просмотров;<Br>
* cr - процентное отношение количества достижений целей к количеству кликов.<Br>
